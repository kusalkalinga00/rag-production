...
def create_kb():
    """Create a knowledge base with some sample documents."""
...
and if you don't know the answer, just say "I don't know."""
    ...
    questions = [
        ...
        "What is the world population?"  # This question is not answerable from the knowledge base
    ]
    ...
    """
    Results :
    uv run rag_pipline.py
        Basic RAG Demo:

        Q: What is LangChain?
        A: LangChain is a framework for developing applications powered by language models, created by Harrison Chase in October 2022. It includes core components like models, prompts, chains, agents, and memory.

        Q: Who created LangChain?
        A: LangChain was created by Harrison Chase.

        Q: What is LangGraph used for?
        A: LangGraph is used for building stateful, multi-actor applications, focusing on state management, cycles and loops, human-in-the-loop interactions, and persistence.
